...
public class App extends MultiDexApplication {
    ...
    private void initParams() {
        ...
        putDefault(HawkConfig.HOME_REC_STYLE, true);         //多行显示: true=开启, false=关闭
        // 播放器选项
        ...
        putDefault(HawkConfig.THEME_SELECT, 1);              //主题: 0=奈飞, 1=哆啦, 2=百事, 3=鸣人, 4=小黄, 5=八神, 6=樱花
        ...
        putDefault(HawkConfig.FAST_SEARCH_MODE, true);       //聚搜模式: true=开启, false=关闭
